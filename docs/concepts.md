...
IMPulse gets alerts from Alertmanager and sends them to [instant messaging app](apps.md) channel based on `application` and `route` configuration (see [Configuration](configuration.md)).
